...
workflow::copy_raw(from = "Tasks/Session 1", to = "Data Files/subj", filetype = ".edat", subj.file = "Data Files/subjlist_final.csv", remove = FALSE)
```
...
See [1. Organize Raw Files](http://englelab.gatech.edu/dataprep/organize-raw-files.html){target="_blank"} in the Data Preparation Guide for more details on this step.
...
**The next chapter is more optional but you will probably find it useful at some point**
