...
These first two steps are all about **Data Preparation**. Getting your data prepared for your planned statistical analyses. 

3. Finally, you are now ready for the fun part, **statistical analyses**. This involves evaluating the univariate descriptive statistics of your data set, running statistical tests, and creating tables and figures to interpret and present your results.
