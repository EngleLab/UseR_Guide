...
Basically, when the `here` package is loaded, `library(here)`, it will search for an .Rproj file and it will set a **starting** file path at that location when you use `here()`.
...
**Let's take a look at some of the R Templates you will be using**
