...
This chapter will cover more intermediate R programming, such as if... then statements, for loops, and functions.

The only required section of this Chapter is If .. then statements. The other sections are more optional but will allow you to do a lot more in R and write more efficient scripts.
