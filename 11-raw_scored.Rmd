...
Save a new R script file as `2_flanker_score.R` in the *R Scripts* folder
...
Now you can add lines of code in the manuscript to execute or `source()` the script "2_flanker_score.R".
