...
In R, the term data wrangling is often times used to refer to performing data manipulation and transformations. The functions you will learn about in this Chapter come from the [**datawrangling** package](https://dr-jt.github.io/datawrangling/){target="_blank"} I developed.
