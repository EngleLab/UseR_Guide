...
Often times the data preparation stage is treated as temporary status of our data and we may not save or store *tidy* data files at this time. **This is a big mistake and will cause more headaches down the road**. I believe this tendency is there because we want to quickly move on to the more interesting phase - **Data Analysis**. As scientists, we should learn to take our time to work with our data. There are many advantages to saving and storing tidy raw data files - this will be explored more throughout this guide.
