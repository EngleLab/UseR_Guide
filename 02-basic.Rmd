...
In R, everything that exists is an object and everything you do to objects are functions. You can define an object using the assignment operator `<-`. For instance,

Everything on the left hand side of the `<-` assignment operator is a newly defined object. Everything on the right hand side of `<-` are functions or values. 
...
However, if I wanted to do something else with the result of that calculation then I would not be able to unless I assigned the result to an object.
...
The point is, you are almost always going to assign the result of some function or value to an object. Printing to the console is not very useful. Every line of code, then, will have an object name on the left hand side of `<-` and a function or value on the right hand side of `<-`
