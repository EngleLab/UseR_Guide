...
Let's set one up for this Tutorial. You will create a study directory in your root `R-Tutorial` folder. Do not create the folder yet.
...
* __Create project as subdirecotry of__: Select Browse and choose where the folder (Directory Name) should be located. In this case browse to your R-Tutorial folder.
