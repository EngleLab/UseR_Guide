...
By far the most common statistical analyses we do in this lab are confirmatory factor analysis (CFA) and structural equation modelling (SEM). 
...
knitr::include_graphics(rep("images/cfa_example.png"))
```
...
This defines a CFA model with three latent factors; **visual**, **textual**, and **speed** with ther respective indicators. The indicators need to correspond to column names in the dataframe.
...
The next two R code chunk's print out a descriptives and correlational tables.
...
knitr::include_graphics(rep("images/sem_example.png"))
```
